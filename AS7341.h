 ...
 *  This version is a **modified and simplified port** by justaLoli
 *  for use in the **STM32** environment with **mbed 2 SDK**.
 *  It includes only the core functionalities necessary for this adaptation.
 *
 *  Original library by Adafruit for the AS7341 breakout:
 ...
 *  Ported and Modified by: justaLoli (2025-5-10)
 *
...
/*
  The Adafruit_AS7341.h library, and subsequently this modified version,
  is adapted from an example with the following Copyright and Warranty:
...
class AS7341 {
  ...
  protected:
    ...
    bool getIsDataReady();
    bool setSMUXLowChannels(bool);
    bool enableSMUX();
    bool enableSpectralMeasurement(bool);
    bool setSMUXCommand(as7341_smux_cmd_t);
    bool setup_F1F4_Clear_NIR();
